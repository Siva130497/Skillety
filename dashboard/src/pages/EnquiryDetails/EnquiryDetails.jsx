    ...
    return (
        <div>
            <div class="main-wrapper main-wrapper-1">
                ...
                <div className="modal fade" id="enquiryviewModal" tabindex="-1" role="dialog" aria-labelledby="enquiryViewLabel"
                    aria-hidden="true">
                    <div className="modal-dialog modal-lg" role="document">
                        <div className="modal-content recruiter-view-modal">
                            <div className="modal-header recruiter-view-modal-header">
                                <h5 className="modal-title recruiter-view-modal-title client" id="enquiryViewLabel">
                                    Enquiry Details_
                                </h5>
                            ...
                            <div className="modal-body">
                                <div className="card p-4 recruiter-view-card candidate">
                                    <div className="row">
                                        ...
                                        <div className="col-12 col-sm-6">
                                            <div className="view-det-sub-head">Sanjay yut</div>
                                        </div>
                                    </div>
                                    <hr />
                                    <div className="row">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-12 col-sm-6">
                                            <div className="view-det-sub-head">newCompany</div>
                                        </div>
                                    </div>
                                    <hr />
                                    <div className="row">
                                        ...
                                        <div className="col-12 col-sm-6">
                                            <div className="view-det-sub-head">engineer</div>
                                        </div>
                                    </div>
                                    <hr />
                                    <div className="row">
                                        ...
                                        <div className="col-12 col-sm-6">
                                            <div className="view-det-sub-head">Jaffna</div>
                                        </div>
                                    </div>
                                    <hr />
                                    <div className="row">
                                        ...
                                        <div className="col-12 col-sm-6">
                                            <div className="view-det-sub-head">Designer</div>
                                        </div>
                                    </div>
                                    <hr />
                                    <div className="row">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-12 col-sm-6">
                                            <div className="view-det-sub-head">our premises</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="modal fade" id="enquirydeleteModal" tabindex="-1" role="dialog" aria-labelledby="enquiryDeleteLabel"
                    ...
                    <div className="modal-dialog" role="document">
                        <div className="modal-content recruiter-delete-modal">
                            <div className="modal-header recruiter-view-modal-header">
                                <h5 className="modal-title recruiter-view-modal-title delete" id="enquiryDeleteLabel">
                                    Warning..!
                                </h5>
                                <a href='#' type="button" className="close recruiter-view-close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true"><i class="bi bi-x close-icon"></i></span>
                                ...
                                <div className="card p-4 recruiter-delete-card">
                                    <div className="recruiter-delete-data-area">
                                        ...
                                        <div className='recruiter-delete-text'>
                                            Are you sure you want to delete this enquiry's data?<br />
                                            <b>You can't undo..!</b>
                                        </div>
                                    </div>
                                </div>
