                        ...
                        <div className="my-app-section">
                            ...
                            <div className='plans--section'>
                                <div className='container-section'>
                                                                ...
                                                                <div className="col-6">
                                                                    <div className="pl-package-detail-view-area">
                                                                        ...
                                                                        <button type="button" className="pl-package-detail-view-btn" title='View More Detail..'
                                                                            data-toggle="modal" data-target="#package_detail_modal">
                                    ...
                                    <div className="modal fade" id="package_detail_modal" tabindex="-1" aria-labelledby="exampleModalLabel" role="dialog" aria-hidden="true">
                                        <div className="modal-dialog modal-dialog-centered" role="document">
                                            <div className="modal-content pl-pack-det-modal">
                                                ...
                                                <div className="modal-footer pl-pack-det-modal-footer">
                                                    <button type="button" className="btn btn-close-btn" data-dismiss="modal">Close</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
