...
const CreatedClients = () => {
    ...
    const handleCheckboxChange = (value) => {
        ...
        axios.post("https://skillety-n6r1.onrender.com/created-clients-column", columnData, {
            headers: {
    ...
    useEffect(() => {
        if (employeeId) {
            ...
            axios.get(`https://skillety-n6r1.onrender.com/created-clients-column/${employeeId}`)
                .then(res => {
                    console.log(res.data);
                    if (res.data) {
                                                                    ...
                                                                    <tr className='dash-table-row client'>
                                                                        ...
                                                                        <td className='text-center'>
                                                                            <div className="action-btn-area">
                                                                                ...
                                                                                <button className='job-edit-btn' title='Edit client details...' onClick={() => navigate(`/create-client`, { state: { id: client.id } })}
                                                                                ...
                                                                                <button className='job-delete-btn' title='Delete client data...' onClick={() => handleDeleteClient(client.id)}
                                                                                    disabled={client.registered}
                                                                                >
