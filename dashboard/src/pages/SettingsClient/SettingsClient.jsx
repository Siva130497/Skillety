...
const SettingsClient = () => {
    ...
    useEffect(() => {
        if (loginClientDetail.companyId) {
            ...
            axios.get(`https://skillety-n6r1.onrender.com/company-detail/${loginClientDetail.companyId}`, {
                headers: {
                    Authorization: `Bearer ${clientToken}`,
                    Accept: 'application/json'
                }
    ...
    const handleEmailUpdate = () => {
        ...
        axios.patch("https://skillety-n6r1.onrender.com/update-client-email", userData, {
            headers: {
                Authorization: `Bearer ${clientToken}`,
                Accept: 'application/json'
            }
    ...
    const handlePhoneUpdate = () => {
        ...
        axios.patch("https://skillety-n6r1.onrender.com/update-client-phone", userData, {
            headers: {
                Authorization: `Bearer ${clientToken}`,
                Accept: 'application/json'
            }
    ...
    const handlePasswordUpdate = () => {
        ...
        axios.patch("https://skillety-n6r1.onrender.com/update-client-password", userData, {
            headers: {
                Authorization: `Bearer ${clientToken}`,
                Accept: 'application/json'
            }
    ...
    const handlePhotoUpdate = () => {
        if (clientImg) {
            ...
            axios.patch(`https://skillety-n6r1.onrender.com/update-client-profile-image/${loginClientDetail.companyId}`, formData, {
                headers: {
                    Authorization: `Bearer ${clientToken}`,
                    Accept: 'application/json'
                }
            ...
            axios.post("https://skillety-n6r1.onrender.com/upload-client-profile-image", formData, {
                headers: {
                    Authorization: `Bearer ${clientToken}`,
                    Accept: 'application/json'
                }
