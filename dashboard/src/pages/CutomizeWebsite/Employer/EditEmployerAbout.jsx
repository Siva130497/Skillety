                                    ...
                                    <div className='admin-lg-table-area man-app p-4'>
                                        ...
                                        <div className='cus-web-input-container'>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea class="form-control dash-form-input" id="advantage1" placeholder="Enter content here..."></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea class="form-control dash-form-input" id="advantage2" placeholder="Enter content here..."></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea class="form-control dash-form-input" id="advantage3" placeholder="Enter content here..."></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea class="form-control dash-form-input" id="advantage4" placeholder="Enter content here..."></textarea>
                                                </div>
                                            </div>
