...
const ATSNavBar = () => {
    ...
    useEffect(() => {
        setToken(JSON.parse(localStorage.getItem('atsToken')))
    }, [token])
    ...
    useEffect(() => {
        if (token) {
            ...
            axios.get("https://skillety-n6r1.onrender.com/candidate-to-ats-notification", {
                headers: {
            ...
            <ul className="navbar-nav navbar-right">
                ...
                <li className="dropdown">
                    <a href="#" data-toggle="dropdown"
                        ...
                        <span>{employeeRole === "Super-Admin" ? "Admin Profile" : "ATS-Staff Profile"}</span>
