...
const ClientLayout = () => {
    ...
    useEffect(() => {
        ...
        $(document).ready(function () {
            ...
            if ($.fn.dropdown) {
                // Initialize dropdown for .notification-toggle
                $(".notification-toggle").dropdown();

                // Initialize NiceScroll when dropdown is shown
            ...
            if ($.fn.dropdown) {
                // Initialize dropdown for .message-toggle
            ...
            $(".needs-validation").submit(function (event) { // Include 'event' as a parameter
                var form = $(this);
            ...
            $(".btn-restore-theme").on("click", function () {
                ...
                // For example, you can call functions like toggle_sidebar_mini and toggle_sticky_header
            ...
            // Set sticky header default to true
            $("#sticky_header_setting").prop("checked", true);
