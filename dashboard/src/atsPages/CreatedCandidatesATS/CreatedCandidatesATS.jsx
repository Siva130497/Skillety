...
const CreatedCandidatesATS = () => {
    ...
    const handleCheckboxChange = (value) => {
        ...
        axios.post("https://skillety-n6r1.onrender.com/created-candidates-ats-column", columnData, {
            headers: {
                Authorization: `Bearer ${atsToken}`,
                Accept: 'application/json'
            }
    ...
    useEffect(() => {
        if (employeeId) {
            ...
            axios.get(`https://skillety-n6r1.onrender.com/created-candidates-ats-column/${employeeId}`)
                .then(res => {
                    console.log(res.data);
                    if (res.data) {
                                                                            ...
                                                                            <tr className='dash-table-row client' key={candidate.id}>
                                                                                ...
                                                                                <td className='text-center'>
                                                                                    <div className="action-btn-area">
                                                                                        ...
                                                                                        <button className='job-edit-btn' title='Edit candidate details...' onClick={() => navigate(`/create-candidate-ats`, { state: { id: candidate.id } })}
                                                                                       ...
                                                                                       <button className='job-delete-btn' title='Delete candidate data...' onClick={() => handleDeleteCand(candidate.id)}
                                                                                            disabled={candidate.registered}
                                                                                        >
...
export default CreatedCandidatesATS