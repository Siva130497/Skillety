                                                                ...
                                                                data?.createdJobs.map((job, jobIndex) => {
                                                                    ...
                                                                    return (
                                                                        <tr key={jobIndex} className='report-table-row with-border'>
                                                                            {jobIndex === 0 && (
                                                                                <td className='report-table-data text-capitalized' rowSpan={data?.createdJobs.length}>{data?.name}</td>
                                                                            )}
                                                                            <td className='report-table-data text-capitalized'>{job?.name}</td>
                                                                            <td className='report-table-data text-capitalized'>{job?.clientName}</td>
