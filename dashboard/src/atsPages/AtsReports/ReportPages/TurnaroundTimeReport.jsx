...
const TurnaroundTimeReport = () => {
    ...
    const getAllJobRoles = async () => {
        try {
          ...
          if (!result.error) {
            console.log(result);
            setjobRoleArray([{ designation: 'Select Job' }, ...result]); // Add "Select Job" option
          } else {
            console.log(result);
          }
        } catch (err) {
    ...
    const handleDropdownChange = (e) => {
        if (e.value && e.value.designation === 'Select Job') {
                                                        ...
                                                        {employeeReportDetail.map((reportData,index)=>{
                                                            return (
                                                                <tr className='report-table-row with-border' key={index}>
                                                                    ...
                                                                    <td className='report-table-data'>{reportData?.clientName}</td>
                                                                    <td className='report-table-data'>{reportData?.createdDate}</td>
