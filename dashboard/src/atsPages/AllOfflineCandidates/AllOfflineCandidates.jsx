                                                ...
                                                <div className="table-responsive table-scroll-area">
                                                    <table className="table table-striped table-hover admin-lg-table">
                                                        <tr className='dash-table-row candidate'>
                                                            ...
                                                            <th className='dash-table-head'>Send</th>
                                                        ...
                                                        <tr className='dash-table-row client'>
                                                            ...
                                                            <td className='text-center'>
                                                                <div className="action-btn-area">
                                                                    <button className='job-view-btn' data-toggle="modal" title='View Candidate Details...' data-target="#candidatesViewModal">
                                ...
                                <div className="card p-4 recruiter-view-card candidate">
                                    <div className="row">
                                        ...
                                        <div className="col-12 col-sm-7">
                                            <div className="view-det-sub-head text-capitalized">Full Name</div>
                                        </div>
                                    </div>
                                    <hr />
                                    <div className="row">
