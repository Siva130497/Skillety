                ...
                <div className='container-fluid container-section'>
                    ...
                    <div className="rpo--enter-bg">
                        <div className="rpo--enter-heading">
                            <h3 data-aos="fade-left">ENTERPRISE</h3>
                        </div>
                    ...
                    <div className="rpo--pro-bg">
                        <div className="rpo--enter-heading">
                            <h3 data-aos="fade-right">PROJECT</h3>
                        </div>
                        <div className="rpo--enter-desc">
                    ...
                    <div className="rpo--enter-bg">
                        <div className="rpo--enter-heading">
                            <h3 data-aos="fade-left">CONTINGENT</h3>
                        </div>
                        <div className="rpo--enter-desc">
                            <p data-aos="fade">Contingent RPO works as an extension of the talent acquisition department and supplies contract staffing solutions using recruiters dedicated to our clients. Our recruiters build a unique talent pipeline of contract labour for our clients based on their specific hiring goals.</p>
                        </div>
                        <div className="rpo--enter-list-area">
                            <ul>
                                <li className='rpo--enter-list-item' data-aos="fade-left">Lorem Ipsum is simply dummy text of the printing and typesetting industry. </li>
                    ...
                    <div className="rpo--pro-bg">
                        <div className="rpo--enter-heading">
                            <h3 data-aos="fade-right">RPO-LITE</h3>
                        </div>
                        <div className="rpo--enter-desc">
