...
const ServicesCVSourcing = () => {
    const [clientToken, setClientToken] = useState("");
    const [talentCVSourceContent, setTalentCVSourceContent] = useState([]);

    useEffect(()=>{
        axios.get("https://skillety-n6r1.onrender.com/web-content?ids=content_60,content_63,content_32,content_33")
        .then(res=>{
          console.log(res.data);
          setTalentCVSourceContent(res.data);
                ...
                <div className='container-fluid services--section'>
                    <div className='container-fluid container-section'>
                            ...
                            <div className="row">
                                <div className="col-12 col-xl-8 col-lg-12 col-md-12 about--left-cover">
                                    <div className="breadcrumb--area" data-aos="fade-down">
                                        ...
                                        <div className="breadcrumb--item">
                                            <p>
                                            {talentCVSourceContent.find(content=>content.id === "content_32")?.content ||
                                                "CV Sourcing"}</p>
                                        </div>
                                    </div>
                                    <div className="services--head">
                                        <h2 data-aos="fade-left">
                                        {talentCVSourceContent.find(content=>content.id === "content_60")?.content ||
                        ...
                        <div className="service-par">
                            <p>
                            {talentCVSourceContent.find(content=>content.id === "content_63")?.content ||
                                ...
                                <div className="row custom-border-bottom custom-border-top">
                                    ...
                                    <div className="col-12 col-lg-5 col-md-12 custom-padding-lr">
                                        <div className="ser--cont-area-right">
                                            ...
                                            {talentCVSourceContent.find(content=>content.id === "content_33")?.content ||
...
export default ServicesCVSourcing;