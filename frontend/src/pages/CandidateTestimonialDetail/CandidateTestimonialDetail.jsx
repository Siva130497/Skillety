...
import './CandidateTestimonialDetail.css';
                    ...
                    <div className='container-fluid container-section'>
                        <div className="custom--container">
                            <div className="breadcrumb--area-dark" data-aos="fade-down">
                                ...
                                <div className="breadcrumb--item-dark">
                                    <a className='sub--bredcrumb-link' href="/candidate-testimonial">Testimonials</a>
                                </div>
                                <div className="breadcrumb--item-dark">
                            ...
                            <div className="testimonial--detail-container" data-aos="fade-up">
                                <div className="test--det-slider-area">
                                    ...
                                    >
                                        <SwiperSlide>
                                            <article className='test--det-card candidate'>
                                                <div className="test--det-card-top-area">
                                                    <img src="assets/img/home-images/testi-profile.jpeg" className='test--det-card-pro-img candidate' alt="" />
                                                    <div className='test-det-card-pro-name-area candidate'>
                                                        <h3 className='test-det-card-pro-name candidate'>KAVITHA KATKAM</h3>
                                                        <h6 className='test-det-card-pro-position candidate'>Senior Manager Talent Acquisition, IVY Software Development Services Pvt. Ltd.</h6>
                                                    </div>
                                                </div>
                                                <div className="test--det-card-desc-area candidate">
                                                    <p className='test--det-card-desc candidate'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
                                                </div>
                                            </article>
                                        </SwiperSlide>
                                    ...
                                    <div className="more--test-card-area">
                                        <div className="row">
                                            ...
                                            <div className="col-12 col-xl-6 ps-xl-4 mt-4 mt-md-0 mt-xl-0 mt-lg-5">
                                                <article className="testimonial--card-lg testi--card-lg candidate" data-aos="zoom-out-left">
                                                    <div className="testimonial--profile-area">
                                                        ...
                                                        <div className="testimonial--profile testi--profile-desc candidate">
                                                            <h5>KAVITHA KATKAM</h5>
                                                            <p>Senior Manager Talent Acquisition, IVY Software Development Services Pvt. Ltd.</p>
                                                        </div>
                                                    </div>
                                                    <div className="testimonial--content-area testi--content-area candidate">
                                                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
                                                    </div>
                                                    <a href='/candidate-testimonial-detail' className='testimonial--arrow-area testi--arrow-area candidate'>
