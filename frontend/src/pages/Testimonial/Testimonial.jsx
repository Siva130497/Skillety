                    ...
                    <div className='container-fluid container-section'>
                        <div className="custom--container">
                            ...
                            <div className="testimonial--container">
                                <div className="row testimonial--row mb-5 mb-lg-4 mb-xl-3 mb-xxl-5">
                                    <div className="col-12 col-xl-6 col-lg-12 pe-xl-4 mb-md-4 mb-lg-5 mb-xl-5">
                                        <article className="testimonial--card-lg testi--card-lg" data-aos="zoom-out-right">
                                            ...
                                            <a href='/testimonial-detail' className='testimonial--arrow-area testi--arrow-area'>
                                ...
                                <div className="row testimonial--row custom">
                                    <div className="col-12 col-xl-6 col-lg-12 ps-xl-4">
                                        <div className="row">
                                            <div className="col-12 col-xl-9 col-lg-6 mb-4">
                                                <article className='testimonial--card-sm testi--card-sm test--card-bg2' data-aos="zoom-out-left">
                                            ...
                                            <div className="col-12 offset-xl-3 col-xl-9 col-lg-6 mb-4">
                                                <article className='testimonial--card-sm testi--card-sm test--card-bg2' data-aos="zoom-out-left">
                                                    <div className="testimonial-sm--profile-area">
                                                        <img src="assets/img/home-images/testi-profile.jpeg" className='testimonial--sm-profile-img' alt="" />
                                                        <div className="testimonial-sm--profile">
                                    ...
                                    <div className="col-12 col-xl-6 ps-xl-4">
                                        <div className="row">
                                            <div className="col-12 col-xl-9 col-lg-6 mb-4" data-aos="zoom-out-left">
                                                <article className='testimonial--card-sm testi--card-sm test--card-bg2' data-aos="zoom-out-left">
                                                    <div className="testimonial-sm--profile-area">
                                                        <img src="assets/img/home-images/testi-profile.jpeg" className='testimonial--sm-profile-img' alt="" />
                                                        <div className="testimonial-sm--profile">
                                ...
                                <div className="row testimonial--row">
                                    <div className="col-12 col-xl-6 col-lg-12 ps-xl-4">
                                        <div className="row">
                                            <div className="col-12 col-xl-9 col-lg-6 mb-4">
                                                <article className='testimonial--card-sm testi--card-sm custom test--card-bg1' data-aos="zoom-out-left">
                                                    <div className="testimonial-sm--profile-area">
                                                        <img src="assets/img/home-images/testi-profile.jpeg" className='testimonial--sm-profile-img' alt="" />
                                                        <div className="testimonial-sm--profile">
                                                            <h5>KAVITHA KATKAM</h5>
