                    ...
                    <div className="row">
                        <div className="col-12 col-lg-8 col-md-12 about--left-cover">
                            ...
                            <div className="about--head">
                                <h2>It’s Time to Make Skillety Work for You</h2>
                            </div>
                        </div>
                ...
                <div className='con--where-section'>
                    <div className="con--where-container">
                        <div className="con--where-heading-area">
                            <h4 className='con--where-heading'>
                                Where Do We Work?
                            </h4>
                        </div>
                        <div className="con--where-desc-area">
                            <p className="con--where-desc">
                        ...
                        <div className="row custom-border-top custom-border-bottom">
                            <div className="col-12 col-lg-7 col-md-12 custom-border-right">
                                <div className="con--map-container">
                                    <h5 className="con--location-heading">
                                        Location
                                    </h5>
                                    <div className="con--map-area">
                                        <img src="assets/img/contact-img/map-img.png" className='con--map-img' alt="" />
                                        <div className='con--map-pointer'></div>
                                        <div className='con--map-link-img-area'>
                            ...
                            <form action="">
                                <div className="row">
                                    <div className="col-12 col-lg-6 col-md-6 custom-padding-right">
                                        <div className='con--form-group custom'>
                                ...
                                <div className="con--form-btn-area">
                                    <button type='submit' className='con--form-btn-sub'>
