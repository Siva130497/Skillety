...
const Enquiry = () => {
    ...
    useEffect(() => {
        if (CSEChoosing) {
            axios.get('https://skillety-n6r1.onrender.com/staff-cse')
                .then((res) => {
    ...
    const enquiryFormDetails = async (detail) => {
        try {
            const response = await axios.post('https://skillety-n6r1.onrender.com/enquiry-form', detail, {
                headers: {
    ...
    const handleMailSending = (email) => {
        ...
        axios.post("https://skillety-n6r1.onrender.com/enquiry-form/cse", { email, enquiryDetail }, {
            headers: {
                'Content-Type': 'application/json',
            },
        })
                    ...
                    <div className='container-fluid'>
                        <div className='container-fluid container-section'>
                            <div className="custom--container">
                                ...
                                <div className="cli--reg-form-area enquiry">
                                    <div className="con--note-form-area" data-aos="fade-up">
                                        <form action="" onSubmit={handleSubmit}>
                                            <div className="row">
                                                ...
                                                <div className="col-12 col-lg-6 col-md-12 col-sm-12 custom-padding-right2 mt-4">
                                                    <div className='reg--form-group cand--reg-custom-padding'>
                                                        ...
                                                        <label htmlFor="position_count" className='reg--form-label cand--reg-custom-padding'>How many positions are open to be outsourced?</label>
                                                    </div>
                                                </div>
                                                <div className="col-12 col-lg-8 col-md-12 col-sm-12 custom-padding-right2 mt-lg-4">
                                                    {/* <div className='reg--form-group'>
                                                    ...
                                                    <div className="cand--reg-form-group can--reg-date enquiry">
                                                        <label htmlFor="deadline" className='reg--form-label-custom' >Tentative deadline to close these positions ?</label>
                                                ...
                                                <div className="col-12 col-lg-12 col-md-12 col-sm-12 custom-padding-left-right mt-5 mt-md-5 mt-lg-4">
                                                    <div className='reg--form-group'>
