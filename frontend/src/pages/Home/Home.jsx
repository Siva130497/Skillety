              ...
              <div className="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-7 col-xxl-7 home--left-cover">
                ...
                <div className="home--popular-area">
                  ...
                  <div className="popular--btn-area">
                    <a href="" className='btn home--popular-btn' data-aos="fade-up" data-aos-delay="150">UI Designer</a>
          ...
          <section className="home--rpo-section">
            ...
            <div className="rpo--content-card">
              <div className="row align-items-xl-center">
                <div className="col-12 col-xl-3 col-xxl-4 col-lg-3">
                  <div className='rpo--card-heading'>
                    <h4 data-aos="fade-right">Enterprise RPO</h4>
                  </div>
                </div>
                <div className="col-12 col-xl-6 col-xxl-5 col-lg-9">
                ...
                <div className="col-12 col-xl-3 col-xxl-3 col-lg-12">
        ...
        <div className='container-fluid container-section'>
          ...
          <section className='home--testimonial-section'>
            ...
            <div className="testimonial--card-area">
              <div className="row">
                <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-7">
                ...
                <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-5 custom-flex-row">
