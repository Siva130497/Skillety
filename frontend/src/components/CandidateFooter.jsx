                            ...
                            <div className="row footer--custom-row">
                                <div className="col-12 col-lg-7 col-xl-7">
                                    <div className="footer--email-left">
                                        ...
                                        <form action="">
                                            <input type="text" className='form-control footer--email-input candidate' data-aos="fade-up"
                                                placeholder='Your email' required />
                                            <div className="footer--sub-btn-area">
                                                <button type='submit' className='footer--sub-btn-sub candidate' data-aos="fade-right">
